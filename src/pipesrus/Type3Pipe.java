...
/**
 * Individual class for Type 3 pipes, inherits nearly everything from Pipe.
 * Largely identical to the other Type Pipe classes, but with validity criteria
 * specific to Type 3 pipes.
 * @author UP744526, UP728600
 */
public class Type3Pipe extends Pipe {  
    
    /**
     * Blank constructor.
     * Specific type 3 specs are initialised inside.
     */
    public Type3Pipe() {
     ...
     */
    public Type3Pipe(double l, double d, int gO, int cO, boolean iI, boolean oR, boolean cR) {
