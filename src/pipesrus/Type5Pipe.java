...
/**
 * Individual class for Type 5 pipes, inherits nearly everything from Pipe.
 * Largely identical to the other Type Pipe classes, but with validity criteria
 * specific to Type 5 pipes.
 * @author UP744526, UP728600
 */
public class Type5Pipe extends Pipe {

    /**
     * Blank constructor.
     * Specific type 5 specs are initialised inside.
     */
    public Type5Pipe() {
        super.gradesValid = new int[]{3, 4, 5};
        super.coloursValid = 2;
        super.innerInsulation = true;
        super.outerReinforcement = true;
    }
     ...
     */
    public Type5Pipe(double l, double d, int gO, int cO, boolean iI, boolean oR, boolean cR) {
